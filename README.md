...
Twitch giveaway wheel — free to use directly in your browser.
...
Copy `local.config.example.js` → `local.config.js` and fill in your Twitch Client ID for full functionality.
